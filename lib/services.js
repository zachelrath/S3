...
export default {
    ...
    */
    ...
    metadataStoreMPObject(bucketName, cipherBundle, params, log, cb) {
        ...
        const longMPUIdentifier = constants.overviewKey(splitter,
            params.objectKey, params.uploadId);
    ...
    metadataValidateMultipart(params, cb) {
        ...
        metadata.getBucket(mpuBucketName, log, (err, mpuBucket) => {
            ...
            const searchArgs = {
                prefix: constants.overviewKey(splitter, objectKey, uploadId),
                marker: undefined,
                delimiter: undefined,
                maxKeys: 1,
            };
    ...
    metadataStorePart(mpuBucketName, partLocations,
        ...
        assert.strictEqual(typeof splitter, 'string');
        const partKey = constants.partKey(uploadId, splitter, partNumber);
        const omVal = {
    ...
    */
    ...
    getSomeMPUparts(params, cb) {
        ...
        const searchArgs = {
            prefix: uploadId,
            marker: constants.partKey(uploadId, params.splitter,
                partNumberMarker),
            delimiter: undefined,
            maxKeys: maxParts,
        };
