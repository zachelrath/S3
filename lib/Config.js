...
class Config {
    ...
    _getConfig() {
        ...
        /**
         * Configure the tokens for versioning support.
         */
        this.versioning = {
            masterPrefix: config.versioning.masterPrefix,
            versionPrefix: config.versioning.versionPrefix,
            separator: config.versioning.separator,
        };
        return config;
    }
}
